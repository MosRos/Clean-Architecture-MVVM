...
object AppBarUtils {
    ...
    fun setLightStatusBar(view: View, activity: Activity, colorRsId: Int) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            activity.window.statusBarColor = ContextCompat.getColor(activity.baseContext, R.color.transparent)
            activity.window.navigationBarColor = ContextCompat.getColor(activity.baseContext, R.color.transparent)
        }
    }
